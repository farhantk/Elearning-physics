        ...
        <div class=" mb-4 border-b border-gray-200 dark:border-gray-700">
            <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="{{ route('dashboard') }}" class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">XII MIPA 1</a>
                    </li>
                    <li class="me-2">
                        <a href="{{ route('dashboard1') }}" class="inline-block p-4   rounded-t-lg  dark:text-blue-500 dark:border-blue-500" aria-current="page">XII MIPA 2</a>
                    </li>
                    <li class="me-2">
