...
@section('content')
<h1 class="text-center">Pemuaian Zat</h1>
...
<p align="justify">Pada pembuatan rel kereta api, sambungan antar rel sengaja dibuat sedikit renggang seperti pada gambar di atas. Hal ini dilakukan untuk memberi ruang pada rel ketika mengalami pemuaian. Perlu diketahui, bahwa terdapat gaya tarik-menarik antar partikel pada setiap partikel bebas yang bergerak dalam suatu zat. Jarak antarpartikel dalam zat padat dapat digambarkan seperti pegas, sebagaimana tampak pada Gambar 17. Apabila zat padat dipanaskan energi getaran yang dimiliki partikel-partikelnya bertambah besar dan jarak antarpartikel menjadi bertambah. Akibatnya, ukuran zat padat menjadi bertambah. Penambahan ukuran zat akibat pemanasan inilah yang dinamakan pemuaian. Pemuaian dapat terjadi pada zat padat, zat cair, dan gas. Pada proses pemuaian, terdapat sebuah koefisien untuk menentukan bagaimana ukuran benda bertambah seiring dengan perubahan suhu. Koefisien ini disebut koefisien muai. </p>
<figure class="h-auto max-w-xs mx-auto">
   <img class=" mx-auto rounded-lg" src="{{URL::asset('/image/gayaantarpartikel.png')}}" alt="image description">
   <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Gambar 17 jarak antarpartikel zat padat</figcaption>
</figure>
...
<ol>
   <li>
      ...
      <ol>
         ...
         <li>
            ...
            <p align="justify">Pemuaian yang terjadi pada zat padat tiga dimensi (berbentuk ruang) disebut sebagai pemuaian volume. Pemuaian volume menggunakan konsep koefisien muai volume yang merupakan perbandingan antara pertambahan volume zat dengan volume zat mula-mula, untuk setiap kenaikan sebesar satu satuan suhu. Secara matematis, koefisien muai volume dapat didefinisikan dengan persamaan sebagai berikut.</p>
            <figure class="h-auto max-w-xs mx-auto">
   ...
   <li>
      ...
      <p align="justify">Lain daripada itu, perlu diketahui bahwa pada zat cair pemuaian yang terjadi hanyalah pemuaian volume dengan persamaan matematis sebagai berikut.</p>
      <p class="text-center italic font-semibold text-black">
         V<sub>t</sub>=V<sub>0</sub> (1+γ∆T)<br>
         ∆V=γV<sub>0</sub> ∆T<br>
      </p>
      <p align="justify">Berikut disajikan video percobaan pemuaian zat cair </p>
   ...
   <li>
      ...
      <p align="justify">Gas yang dipanaskan akan menyebabkan terjadinya pemuaian volume dan pemuaian tekanan. Dengan demikian, berdasarkan proses pemanasannya, pemuaian gas memiliki beberapa persamaan diantaranya yaitu sebagai berikut. </p>
      ...
      <ol>
         <li>
            ...
            <p align="justify">Gas di dalam ruang tertutup dengan tutup yang bebas bergerak (Gambar 22a) yang dipanaskan pada tekanan tetap, maka akan menyebabkan volume gas memuai sebanding dengan suhu mutlak gas tersebut (Gambar 22b) atau secara matematis dapat dituliskan: </p>
            <figure class="h-auto max-w-xs mx-auto">
         ...
         <li>
            ...
            <p align="justify">Gas yang dipanaskan dalam ruang tertutup, maka akan menyebabkan tekanan gas memuai sebanding dengan suhu mutlak gas tersebut dimana jika pemanasan terjadi secara terus menerus, maka dapat terjadi ledakan. Secara matematis, proses ini dapat dituliskan sebagai berikut:</p>
            <figure class="h-auto max-w-xs mx-auto">
               <img class=" mx-auto rounded-lg" src="{{URL::asset('/image/isohorik.png')}}" alt="image description">
            </figure>
         </li>
         <li>
            <strong>Pemuaian Volume Gas pada Suhu Tetap (Isotermik)</strong>
            <figure class="h-auto max-w-xs mx-auto">
            ...
            <p align="justify">Gas di dalam ruang tertutup dengan tutup yang dapat digerakkan dengan bebas (Gambar 24a), pada saat tutup tabung digerakkan secara perlahan-lahan agar suhu gas di dalam tabung tetap maka pada saat volume gas diperkecil ternyata tekanan gas dalam tabung bertambah besar dan bila volume gas diperbesar ternyata tekanan gas dalam tabung mengecil.atau secara matematis dapat dituliskan:</p>
            <figure class="h-auto max-w-xs mx-auto">
               <img class=" mx-auto rounded-lg" src="{{URL::asset('/image/isotermis.png')}}" alt="image description">
            </figure>
         </li>
      </ol>
      <p align="justify">Untuk proses pemuaian gas yang terjadi pada tekanan, volume, dan suhu yang berubah maka dapat diselesaikan dengan persamaan hukum Boyle-Gay Lussac yaitu sebagai berikut.</p>
      <figure class="h-auto max-w-xs mx-auto">
         <img class=" mx-auto rounded-lg" src="{{URL::asset('/image/boyle.png')}}" alt="image description">
      </figure>
      <p align="justify">Berikut disajikan video percobaan sederhana pemuaian zat gas, cobalah di rumah untuk ikut membuktikannya!</p>
