...
<figure class="h-auto max-w-xs mx-auto">
   ...
   <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Gambar 1  Demam dan suhu</figcaption>
</figure>
...
<p>
   Pada gambar 3 di bawah ini disajikan batas atas dan batas bawah dari empat skala termometer yang berbeda
</p>
<figure class="h-auto max-w-xs mx-auto">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
   <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      <caption class='text-center'>Tabel 1 Batas atas dan bawah 4 skala termometer</caption>
...
<p>
   Dari batas bawah dan batas atas skala, dapat diperoleh jumlah skala yang merupakan selisih antara batas atas skala dengan batas bawah skala. Jumlah skala termometer, jika dibandingkan maka akan diperoleh seperti gambar 6 berikut.
</p>

<figure class="h-auto max-w-xs mx-auto">
   <img class=" mx-auto rounded-lg" src="{{URL::asset('/image/perbandinganSkala.jpg')}}" alt="image description">
   <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Gambar 4 Perbandingan skala</figcaption>
</figure>

<p>Secara umum, kita dapat melakukan konversi suhu dari satu skala ke skala suhu lainnya dengan cara sebagai berikut</p>
<figure class="h-auto max-w-xs mx-auto">
...
<p>Maka, untuk mengonversi suhu dari celcius, reamur, fahrenheit, dan kelvin satu dengan lainnya diperoleh cara seperti yang dijelaskan pada tabel 2 berikut.</p>
